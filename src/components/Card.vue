<template>
  <article 
    class="card 
        bg-gray-dark rounded-xl text-center
        p-8 pb-0 md:p-12 md:pb-0
        w-full max-w-[540px] relative
  ...
  >
    ...
    <p 
      class="advice text-light text-2xl font-bold transition-all ease-out duration-700"
      :class="{ 'opacity-0 translate-y-4': loading }"
    >
      &#8220;{{ advice }}&#8221;
    </p>
    ...
    <button
      ...
      class="rounded-full bg-accent w-16 h-16 flex items-center justify-center mx-auto
            translate-y-[50%]"
